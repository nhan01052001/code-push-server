...
export function encryptData(data: any): string {
  ...
  return CryptoUtils.encrypt(data, import.meta.env.VITE_ENCRYPTION_KEY || '');
}
...
export function decryptData(
  ...
  return CryptoUtils.decrypt(encryptedData, import.meta.env.VITE_ENCRYPTION_KEY || '', parseJson);
}
